...
typedef enum _tkproto_ControllerConnectionPayload_ControllerType {
    ...
    tkproto_ControllerConnectionPayload_ControllerType_BOND = 6
...
#define _tkproto_ControllerConnectionPayload_ControllerType_MAX tkproto_ControllerConnectionPayload_ControllerType_BOND
#define _tkproto_ControllerConnectionPayload_ControllerType_ARRAYSIZE ((tkproto_ControllerConnectionPayload_ControllerType)(tkproto_ControllerConnectionPayload_ControllerType_BOND+1))
